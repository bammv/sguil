proc GetWhoisData { socketID ip } {

    # The default is to call SimpleWhois.
    # SimpleWhois returns results in a big list.
    # We take those results, add <BR>'s and base64 encode them to send to the client requester.

    SendSocket $socketID [list InsertWhoisData [base64::encode [join [SimpleWhois $ip] "<BR>"]] ]
    #SendSocket $socketID [list InsertWhoisData [base64::encode "<BR>$ip<BR>" ]]
